...
//TAMPILKAN
     public static void readhias() throws IOException{
         ...
         for (int i = 0; i < perhiasan.size(); i++){
            ...
            System.out.println("Nama Perhiasan : " + perhiasan.get(i).namaperhiasan);
            System.out.println("Jenis : " + perhiasan.get(i).jenis);
            System.out.println("Karat : " + perhiasan.get(i).Karat);
            System.out.println("Berat : " + perhiasan.get(i).Berat); 
            System.out.println("\n");
         }
     }
